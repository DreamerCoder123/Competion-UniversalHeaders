...
#define RUN_TOWARDS 255, 255                            // 向后行进
#define RUN_AFTERWARDS -255, -255                       // 向前行进
...
namespace Arm_opreations
{
    ...
    namespace Catch_Book
    {
        namespace constants
        {
            ...
            const short int rigp1_base = 837; // 运动到右边的第一本书
            const short int rigp2_base = 800; // 运动到右边的第二本书
            const short int left1_base = 540; // 运动到左边的第一本书
            const short int left2_base = 580; // 运动到左边的第二本书
            const short int catch_tightness = 1450;

        }
        short int p1[] = {1300, 1250, 1350, 1200, 650, 1200, constants::p_base};
        short int p2[] = {1300, 780, 1750, 1200, 650, 1200, constants::p_base};
        ...
        short int rigp2[] = {constants::catch_tightness, 1100, 2050, 1200, 650, 1200, constants::rigp1_base};
        short int rigp3[] = {1400, 1100, 2050, 1200, 650, 1200, constants::rigp1_base};
        // 1400,1225,2050,1200,650,1200,840
        //
        short int rigp_1[] = {constants::catch_tightness, 1850, 1950, 1200, 650, 1200, constants::rigp2_base};
        short int rigp_2[] = {constants::catch_tightness, 1100, 2050, 1200, 650, 1200, constants::rigp2_base};
        short int rigp_3[] = {1400, 1100, 2050, 1200, 650, 1200, constants::rigp2_base};
        // 运动到左边释放书
        short int lefp1[] = {constants::catch_tightness, 1650, 1950, 1200, 650, 1200, constants::left1_base};
        short int lefp2[] = {constants::catch_tightness, 1100, 2050, 1200, 650, 1200, constants::left1_base};
        short int lefp3[] = {1400, 1100, 2050, 1200, 650, 1200, constants::left1_base};

        short int lefp1_[] = {constants::catch_tightness, 1650, 1950, 1200, 650, 1200, constants::left2_base};
        short int lefp2_[] = {constants::catch_tightness, 1100, 2050, 1200, 650, 1200, constants::left2_base};
        short int lefp3_[] = {1400, 1100, 2050, 1200, 650, 1200, constants::left2_base};
